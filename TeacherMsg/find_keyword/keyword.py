...
jieba.load_userdict(os.path.join(this_path, '../jieba_dict/name.txt'))
jieba.load_userdict(os.path.join(this_path, '../jieba_dict/college.txt'))
# 使用自定义停用词集合
analyse.set_stop_words(os.path.join(this_path, "../jieba_dict/stopword.txt"))
